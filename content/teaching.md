...
SC4064 is a GPU-focused course introduced in 2026. It covers fundamental GPU architecture and programming concepts, along with emerging topics such as sparse tensor cores, container-based AI deployment, and heterogeneous computing.
Here's the schedule used for AY25S2 as a reference.
...
*Note: for future offerings, the Quiz will likely move towards the end of the semester.*
...
*Note: project team composition and topics will likely change in future offerings.*
